...
def evaluate_val_adaboost(X_train, y_train, X_val, y_val, base_max_depth=1, verbose = True, **params):
...
def concat_and_train_AB(X_train, y_train, X_val, y_val,base_max_depth=1, verbose=True, **params):
