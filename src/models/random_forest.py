...
def evaluate_val_random_forest(X_train, y_train, X_val, y_val, verbose = False, **params):
...
def concat_and_train_RF(X_train, y_train, X_val, y_val, verbose= False, **params):
